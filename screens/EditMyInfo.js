...
function EditMyInfo({ navigation }) {
    ...
    const handleImagePick = async () => {
        ...
        if (!granted && status !== 'granted') {
            ...
            if (status !== 'granted') {
                Alert.alert('Tillstånd nekad', 'Tillstånd att komma åt mediebibliotek nekad.', [{ text: 'Tamam' }]);
                return;
            }
        }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Spinner visible={loading} textContent={'Loading...'} textStyle={styles.loadingText} />
        </ScrollView>
    );
}
